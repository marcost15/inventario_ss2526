...
include './modelo/bd_opc_niveles.php';
...
$f1->radioButton('Nivel','nivel_id',bd_opc_niveles(),FH_NOT_EMPTY,true);
...
$ss2526->assign('nniveles',$nniveles);
$ss2526->assign('niveles',$niveles);
$ss2526->assign('tabla',$paginas);
$ss2526->assign('ids',$ids);
