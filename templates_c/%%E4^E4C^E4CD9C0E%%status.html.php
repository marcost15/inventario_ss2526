<?php /* Smarty version 2.6.26, created on 2012-09-30 22:11:39
         compiled from status.html */ ?>
﻿<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "cabecera.html", 'smarty_include_vars' => array('title' => "SS2526 - Status de Equipos")));
...
?>
<tr>
	<td><?php echo $this->_tpl_vars['status'][$this->_sections['i']['index']]['nombre']; ?>
</td>
	<td width="10%"><a href="?id=<?php echo $this->_tpl_vars['status'][$this->_sections['i']['index']]['id']; ?>
