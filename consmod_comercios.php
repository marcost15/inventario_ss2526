...
if (bd_verificar_privilegios('consmod_comercios.php',$_SESSION['usuario']['nivel_id'])!='CONCEDER')
{
	ir('negacion_usuario.php');
}
$error1 = '0';

$f1  = new formHandler('busqueda_comercios',NULL,'onclick="highlight(event)"');
$f1->setLanguage('es');
